    ...
    public class DebuggerWindow : EditorWindow {
        ...
        public void Init() {
            ...
            operatorToString = new Dictionary<Operator, string> {
                ...
                [Operator.IS_GREATER] = ">",
                [Operator.IS_SMALLER_OR_EQUAL] = "<=",
                [Operator.IS_SMALLER] = "<",
                [Operator.ALWAYS_TRUE] = "ALWAYS_TRUE"
            };
            ...
            nestedBoxStyle = new GUIStyle {
                margin = new RectOffset(nestedPadding, 0, 0, 0)
            };
        ...
        public void OnSelectionChange() {
            ...
            if (selectedObject != null) {
                selectedDebugger = selectedObject.GetComponentInChildren<Debugger>();
            }
        ...
        public void OnGUI() {
            if (nameToTagString == null) {
                Init(); // Weird recompile bug fix
            }
