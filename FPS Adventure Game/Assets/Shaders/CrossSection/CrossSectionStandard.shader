...
Shader "CrossSection/Standard"
{
	Properties
	{
		...
		_SectionPlane	("Section Plane Normal (x,y,z)",	Vector)	= ( 0, 1, 0, 1 )
		_SectionPoint	("Section Point (x,y,z)",	Vector)	= ( 0, 0, 0, 1 )

		_SectionOffset ("Section Offset", Float) = 0.0
	...
	SubShader
	{
	   ...
	   Pass {
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_ONE
