...
public class Clipper : System.Object {
    ...
    private Dictionary<string, int[]> materialSelectors;
    ...
    private void PrepareMaterials(GameObject prefab) {
        ...
        materialSelectors = new Dictionary<string, int[]>();
        ...
        foreach (Material m in modelMaterials) {
...
#endif
            if (clipShader == null) {
                clipShader = Shader.Find("CrossSection/" + shaderName);
            }
            ...
            //clipMat.color = Color.magenta; // debug/test: make it obvious when the clip material is active
